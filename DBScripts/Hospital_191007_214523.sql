...
-- User.gender [User#att11]
-- Unable to compute the view for the derived element 'gender [User#att11]'
-- com.webratio.ide.derivation.DerivationException: Unable to generate view for attribute: gender [User#att11] ()
