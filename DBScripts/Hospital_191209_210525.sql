...
alter table `emergency_operation`   add index fk_emergency_operation_emergen (`emergency_room_id_room`), add constraint fk_emergency_operation_emergen foreign key (`emergency_room_id_room`) references `emergency_room` (`room_id_room`);
