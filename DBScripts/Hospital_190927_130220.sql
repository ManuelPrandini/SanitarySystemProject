...
-- treatment_Drug [rel8]
alter table `drug`  add column  `treatment_idtreatment`  integer;
alter table `drug`   add index fk_drug_treatment (`treatment_idtreatment`), add constraint fk_drug_treatment foreign key (`treatment_idtreatment`) references `treatment` (`idtreatment`);
